...
<h3>Register Nummber: 212224060264</h3>
...
```
OUTPUT:
<img width="552" height="251" alt="image" src="https://github.com/user-attachments/assets/b46f1b5a-d9be-441b-8a19-079b150068f7" />

RESULT:
```
Thus,AI is developed successfully
```
